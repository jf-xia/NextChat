...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ...
      : `😆 对话遇到了一些问题，不用慌:
       \ 1️⃣ 想要零配置开箱即用，[点击这里立刻开启对话 🚀](${SAAS_CHAT_UTM_URL})
       \ 2️⃣ 如果你正在使用私有部署版本，请返回首页点击“使用微软账号登录”按钮完成认证 🔑
  ...
  Auth: {
    Return: "返回",
    Title: "需要登录",
    Tips: "请使用微软账号完成登录即可继续访问。",
    SubTips: "登录成功后会自动返回应用。",
    Input: "微软登录",
    Confirm: "使用微软账号登录",
    Later: "稍后再说",
    SaasTips: "配置太麻烦，想要立即使用",
    TopTips:
      "🥳 AIChat AI 首发优惠，立刻解锁 OpenAI o1, GPT-4o, Claude-3.5 等最新大模型",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        ...
        Label: "（性价比最高的方案）",
        SubTitle:
          "由 AIChat 官方维护, 零配置开箱即用，支持 OpenAI o1, GPT-4o, Claude-3.5 等最新大模型",
        ChatNow: "立刻对话",
      },
      AccessCode: {
        Title: "访问密码",
