...
const tw = {
  ...
  Error: {
    ...
    \\ 2️⃣ 如果你想消耗自己的 OpenAI 資源，點選[這裡](/#/settings)修改設定 ⚙️`
      : `😆 對話遇到了一些問題，不用慌:
    \ 1️⃣ 想要無須設定開箱即用，[點選這裡立刻開啟對話 🚀](${SAAS_CHAT_UTM_URL})
    \ 2️⃣ 如果你正在使用私有部署版本，請回到首頁點選「使用微軟帳號登入」按鈕完成驗證 🔑
 ...
 `,
  ...
  Auth: {
    Title: "需要登入",
    Tips: "請使用微軟帳號登入即可繼續使用。",
    SubTips: "登入成功後會自動返回應用。",
    Input: "微軟登入",
    Confirm: "使用微軟帳號登入",
    Later: "稍候再說",
    Return: "返回",
    ...
    TopTips:
      "🥳 AIChat AI 首發優惠，立刻解鎖 OpenAI o1, GPT-4o, Claude-3.5 等最新的大型語言模型",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        ...
        Label: "(性價比最高的方案)",
        SubTitle:
          "由 AIChat 官方維護，無須設定開箱即用，支援 OpenAI o1、GPT-4o、Claude-3.5 等最新的大型語言模型",
        ChatNow: "立刻開始對話",
      },
